...
public class Player : MovingObject
{
	...
	public int pointsPerFood = 10;              //Number of points to add to player hit points when picking up a food object.
	public int pointsPerSoda = 20;              //Number of points to add to player hit points when picking up a soda object.
	...
	private void Update()
	{
		...
		{
			if ((base.facingRight && horizontal == -1) || (!base.facingRight && horizontal == 1))
				base.Flip();
	...
	private void OnTriggerEnter2D(Collider2D other)
	{
		...
		else if (other.tag == "Food")
		{
			...
			health = (health + pointsPerFood < 100 ? health + pointsPerFood : 100);
		...
		else if (other.tag == "Soda")
		{
			...
			health = (health + pointsPerSoda < 100 ? health + pointsPerSoda : 100);
